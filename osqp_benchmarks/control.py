"""
Implementation of a random problem generation with a optimal control structure,
obtained from https://github.com/osqp/osqp_benchmarks.
...
# problem = ControlExample(3)
# print(problem.qp_problem)
